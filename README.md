# All in One Accessibility®: GLPi CMS Plugin
...
Step 1: Extract the allinoneaccessibility.zip file inside plugin folder
Step 2: After extracting you can see the All in One Accessibility plugin in plugin list
Step 3: Click on install button to get started, then click on enable button
Step 4: After enable, you can see the plugin configure icon to manage plugin
